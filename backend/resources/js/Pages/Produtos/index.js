...
const Produtos = (props) => {
    ...
    return (
        <Menu title="Produtos" user={usuario}>
            <Box dir={'rtl'} style={{display: 'flex', alignItems: 'end', marginBottom: "20px"}}>
                <Fab color={"primary"} size={"large"}
                    component={InertiaLink}
                     href={route('tenant.produtos-create', props.prefix)}
                >
                    <Add/>
                </Fab>
            </Box>
                ...
                <Table className={classes.table} aria-label="customized table">
                    ...
                    <TableBody>
                            <StyledTableRow>
                                ...
                                <StyledTableCell>Camiseta</StyledTableCell>
                                <StyledTableCell>Moda</StyledTableCell>
                                <StyledTableCell>R$ 95,00</StyledTableCell>
