...
class StorageLinkCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'storage:link {--relative : CategoryCreate the symbolic link using relative paths}';
     ...
     * @var string
     */
    protected $description = 'CategoryCreate the symbolic links configured for the application';
